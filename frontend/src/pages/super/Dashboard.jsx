    ...
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900">
          Welcome, {user?.name || 'Super Doctor'}
        </h1>
        <p className="text-gray-600 mt-1">Manage staff and oversee operations</p>
      </div>
      ...
      <div className="mt-8 bg-white rounded-lg shadow">
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button
              onClick={() => (window.location.href = '/super/staff')}
            ...
            >
              ...
              <p className="font-medium text-gray-900">View Staff List</p>
            </button>
