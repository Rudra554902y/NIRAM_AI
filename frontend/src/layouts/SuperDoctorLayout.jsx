...
const SuperDoctorLayout = () => {
  ...
  const navigation = [
    { name: 'Dashboard', href: '/super/dashboard', icon: Home },
    { name: 'Staff Management', href: '/super/staff', icon: Users },
    { name: 'Profile', href: '/super/profile', icon: User },
  ];
          ...
          <div className="p-6 border-b border-gray-200">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Super Doctor</p>
              </div>
            </div>
          </div>
...
export default SuperDoctorLayout;
